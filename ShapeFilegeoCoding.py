...
dataFrame.to_csv('sampleDataTest.csv')

coords_data = pd.read_csv('sampleDataTest.csv')
coords_gdf = gpd.GeoDataFrame(coords_data, geometry=gpd.points_from_xy(coords_data['lat'], coords_data['lng']))
coords_gdf.to_file(filename='coordinatesInShapeFile.shp', driver="ESRI Shapefile")
